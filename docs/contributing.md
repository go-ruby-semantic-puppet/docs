...
Contributions are welcome. `go-ruby-semantic-puppet/semantic-puppet` is built to a small set of
...
The library is in [`github.com/go-ruby-semantic-puppet/semantic-puppet`](https://github.com/go-ruby-semantic-puppet/semantic-puppet).
This documentation site is in [`github.com/go-ruby-semantic-puppet/docs`](https://github.com/go-ruby-semantic-puppet/docs).
