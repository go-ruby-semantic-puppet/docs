...
The public API lives at the module root (`github.com/go-ruby-semantic-puppet/semantic-puppet`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `semantic-puppet`, while the surface follows
...
```go
import "github.com/go-ruby-semantic-puppet/semantic-puppet"
```
...
- **[pkg.go.dev/github.com/go-ruby-semantic-puppet/semantic-puppet](https://pkg.go.dev/github.com/go-ruby-semantic-puppet/semantic-puppet)**

The module's [README](https://github.com/go-ruby-semantic-puppet/semantic-puppet#readme) carries worked
